...
<div class="row">
    <div class="col-sm-12">
        <h4 class="text-info" style="margin:0; padding: 0;">Position: Sales Executive</h4>
        <h4 class="text-info" style="padding:0">Report to Sales Manager</h4>
        <br/>
        ...
        <h4 class="text-info">Position: Software Design Engineer</h4>
